...
class Tpl_head extends Tpl_root {
	...
	{
		$this->style[] = 'backend/plain/main.css';
		...
		$this->js[] = 'jquery/jquery.easing-sooper.js';
		$this->js[] = 'jquery/jquery.sooperfish.js';
	...
	function view()
	{
		...
		return $this->load->view(folder_path($this->tpl_folder).'backend/plain/head', $this->data, TRUE);
	}
}
