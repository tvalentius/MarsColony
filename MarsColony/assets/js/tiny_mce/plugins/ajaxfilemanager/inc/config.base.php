...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	//FILESYSTEM CONFIG
		...
		*/
	define('CONFIG_SYS_MY_DOCROOT',
		$_SERVER['DOCUMENT_ROOT'] . implode('/',array_slice(explode('/',$_SERVER['PHP_SELF']),0,-6))
	);
		
	define('CONFIG_SYS_DEFAULT_PATH', CONFIG_SYS_MY_DOCROOT.'/assets/files/tiny_mce/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', CONFIG_SYS_MY_DOCROOT.'/assets/files/tiny_mce/');	//accept relative path only
