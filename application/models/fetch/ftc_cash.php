...
class Ftc_cash extends Ftc_root {
	
	public function __construct($Obj=FALSE)
	{
		//Import Needed Model
		$this->load->model(QUERY_PATH.'qry_cash');
		//End Import
		parent::__construct(new Qry_cash($Obj), $Obj);
	}
	...
	public function filter_wall_reward()
	{
		$this->qry->where[] = $this->qry->create_date_start(current_date()." 00:00:00");
		$this->qry->where[] = $this->qry->create_date_end(current_date()." 23:59:59");
		$this->qry->where[] = $this->qry->type("fbwall");
		return $this;
	}
