...
function cke_initialize($data = array()) {
	...
	if(!defined('CI_CKEDITOR_HELPER_LOADED')) {
		...
		$return =  '<script type="text/javascript" src="'.JS_PATH. 'ckeditor/ckeditor.js"></script>';
		$return .=	"<script type=\"text/javascript\">CKEDITOR_BASEPATH = '" . JS_PATH . "ckeditor/';</script>";
	} 
